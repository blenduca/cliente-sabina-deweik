/* ==========================================================================
   ...
   --------------------------------------------------------------------------
   ⚠️ ARQUIVO ESPELHADO. A cópia gêmea vive em
      2-motor-de-crescimento/marketing/lp-comunidade-gratuita/assets/atribuicao.js
   Mudou aqui, muda lá. Os dois ativos têm deploys independentes (este roda no
   Vite, a LP da comunidade é estática pura), então não há como compartilhar um
   único arquivo antes de a plataforma ter build. Quando tiver, isto vira pacote.
